...
var FileHandler = /** @class */ (function () {
    ...
    FileHandler.prototype.readFile = function (filePath) {
        ...
        return new Promise(function (resolve, reject) {
            fs_1.readFile(resolvedFilePath, { encoding: "utf8" }, function (err, data) {
                if (err) {
    ...
    FileHandler.prototype.writeFile = function (filePath, fileTemplateBuffer) {
        ...
        fs_1.writeFile(resolvedFilePath, fileTemplateBuffer.getText(), function (err) {
            if (err) {
    ...
    FileHandler.prototype.writeTextToFile = function (filePath, text) {
        var resolvedFilePath = path.resolve(__dirname, filePath);
        fs_1.writeFile(resolvedFilePath, text, function (err) {
            if (err) {
                console.log("Error writing file " + filePath);
            }
            console.log("File " + resolvedFilePath + " written");
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        configValue = "node node_modules/dynatrace-rn-lib/lib/scripts/config.js && node node_modules/@dynatrace/react-native-plugin/scripts/instrument.js";
